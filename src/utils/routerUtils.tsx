...
export function useLoaderData<TLoader extends ReturnType<typeof makeDeferredLoader>>() {
    return useRrdLoaderData() as ReturnType<TLoader>["data"];
}

export function makeDeferredLoader<TData extends Record<string, unknown>>(dataFunc: (args: LoaderFunctionArgs) => TData) {
